...
## 目录规则
- 模板 history 存放位置：`/root/.openclaw/skills/gpt-image-2/template/anime-girl-and-man-date-photo-collage-3x3/history/`
...
## 推荐调用
```bash
cd /root/.openclaw/skills/gpt-image-2/template/anime-girl-and-man-date-photo-collage-3x3
