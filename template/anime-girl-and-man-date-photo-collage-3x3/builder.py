...
import re
from scene_generator import generate_dynamic_scenes
...
TEMPLATE_NAME = "anime-girl-and-man-date-photo-collage-3x3"

def build_prompt(template, variables, endpoint_provider=None):
    variables = generate_dynamic_scenes(template, variables or {}, endpoint_provider) if endpoint_provider else (variables or {})
