...
FIXED_TEMPLATE = "bedroom-mirror-selfie"
...
Routing:
  ...
  - output:  ~/.hermes/output/gpt-image-2/bedroom-mirror-selfie/

Notes:
  - do not pass --template here; this runner fixes it automatically
  - any generated image lands in ~/.hermes/output/gpt-image-2/bedroom-mirror-selfie/
"""
